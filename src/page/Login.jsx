...
const Login = () => {
    ...
    return (
        <div className="hero min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-slate-200 font-sans">
            ...
            <meta name="description" content="Login and buy amazing foods from our exclusive collection." />
            
            <div className="hero-content flex-col lg:flex-row-reverse gap-8 lg:gap-16 w-full max-w-7xl px-4">
                
                {/* Text Side - Hidden on small mobile for cleaner look, visible on mid/large */}
                <div className="text-center lg:text-left lg:w-1/2 animate-fade-in-up">
                    ...
                    <p className="py-6 text-slate-600 text-lg md:text-xl leading-relaxed">
                        Sign in to access your orders, saved favorites, and exclusive food deals tailored just for you.
                    </p>
                </div>
                ...
                <div className="card shrink-0 w-full max-w-sm md:max-w-md shadow-2xl bg-white border border-slate-100 transition-all duration-300 hover:shadow-slate-300/50">
                    <form onSubmit={handleLogin} className="card-body pb-4">
                        ...
                        {/* Header within card for mobile context */}
                        ...
                        <div className="form-control space-y-1 mt-3">
                            ...
                            />
                            <label className="label">
                                <a href="#" className="label-text-alt link link-hover text-slate-500 hover:text-primary">
                                    Forgot password?
                                </a>
                            </label>
                        </div>
                        ...
                        {error && (
                            <div className="alert alert-error text-sm py-2 mt-2 rounded-lg shadow-sm">
                    ...
                    <div className="px-8 pb-8 pt-0">
                        <div className="divider text-slate-400 text-sm font-medium my-6">OR LOGIN WITH</div>
                        
                        <button 
                            onClick={handleGoogleSignIn} 
                            className="btn btn-outline w-full gap-2 border-slate-300 text-slate-700 hover:bg-slate-50 hover:border-slate-400 hover:text-slate-900 transition-colors relative"
                        >
